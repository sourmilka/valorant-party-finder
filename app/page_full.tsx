...
const serverOptions = [
  'Chicago, IL (USA)', 'Dallas, TX (USA)', 'Los Angeles, CA (USA)', 'New York, NY (USA)',
  'London (UK)', 'Frankfurt (Germany)', 'Paris (France)', 'Stockholm (Sweden)',
  'Tokyo (Japan)', 'Seoul (South Korea)', 'Sydney (Australia)', 'Mumbai (India)'
];
